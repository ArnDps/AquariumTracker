...
public enum PlantReferenceEnvironment
{
    FreshwaterTropical,
    Marine
}

public sealed class PlantReference
{
    public Guid Id { get; set; } = Guid.NewGuid();
    public PlantReferenceEnvironment Environment { get; set; } = PlantReferenceEnvironment.FreshwaterTropical;
    ...
    public string LightNeed { get; set; } = string.Empty;
    public string Co2Need { get; set; } = string.Empty;
    public string FertilizationNeed { get; set; } = string.Empty;
    public string GrowthSpeed { get; set; } = string.Empty;
    public string RecommendedPlacement { get; set; } = string.Empty;
